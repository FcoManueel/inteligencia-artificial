    ...
    def inicia_juego(self, max_pasos=150):
        ...
        for paso in range(max_pasos):
            ...
            if resultado is not None:
                showinfo("Fin de juego", ['EMPATE', 'GANAN AZULES', 'GANAN ROJAS'][resultado])
                return resultado
            estado_anterior = estado
...
class JugadorNegamax(JugadorInterfazTK):
    ...
    def decide_jugada(self, juego, estado, jugador, tablero):
        ...
        """
        return max(self.ordena(juego, estado, juego.jugadas_legales(estado, jugador)),
    ...
    def negamax(self, juego, estado, jugador, alpha, beta, profundidad):
        ...
        for jugada in self.ordena(juego, estado, juego.jugadas_legales(estado, jugador)):
